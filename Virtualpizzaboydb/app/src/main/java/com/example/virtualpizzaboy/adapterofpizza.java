...
public class adapterofpizza extends FirebaseRecyclerAdapter<datamodel,adapterofpizza.myviewholder> {

    public adapterofpizza(@NonNull FirebaseRecyclerOptions<datamodel> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull @NotNull myviewholder holder, int position, @NonNull datamodel model) {
        ...
        holder.addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activity.getSupportFragmentManager().beginTransaction().add(R.id.frame, new pizzadescriptions(model.getName(),model.getPrice(),model.getPurl()))
